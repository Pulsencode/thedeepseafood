...
urlpatterns = [
    ...
    path('get_product_index/',views.IndexProductView.as_view(),name="get_product_index"),
    path('about', views.AboutView.as_view(),name='about'),
    path('product', views.ProductView.as_view(),name='product'),
    path('get_product_lists/',views.ProductListingView.as_view(),name="get_product_lists"),
    path('search_product/',views.SearchProductView.as_view(),name="search_product"),
    

    path('product-details/<slug:slug_product>/', views.ProductDetailsView.as_view(),name='product_details'),
    path('product_details_switch/',views.GeneralProductDetailsView.as_view(),name="product_details_switch"),

    path('brands/oceano', views.BrandView.as_view(),name='brands'),
    path('brands-list', views.BrandsListView.as_view(),name='brands_list'),
    
    path('get_product_content/', views.ProductContentView.as_view(), name='get_product_content'),
    path('load_more_product/',views.load_more_product,name="load_more_product"),
    path('get_product_details/',views.OceanoProductDetailsView.as_view(),name="get_product_details"),
    path('get_modal_product_details/',views.OceanoModalProductDetailsView.as_view(),name="get_modal_product_details"),
    ...
    path('news-details/<int:id>/', views.NewsDetailsView.as_view(),name='news_details'),
    
    path('promotion-view/<int:id>/', views.PromotionView.as_view(),name='promotion_details'),
