!(function (t) {
  ...
  !(function () {
    ...
    (t.position = {
        ...
        return (
          ...
          this.each(function () {
            ...
            "right" === e.my[0]
              ...
              "bottom" === e.my[1]
                ? (T.top -= u)
                : "center" === e.my[1] && (T.top -= u / 2),
              (T.left += P[0]),
              (T.top += P[1]),
              i || ((T.left = o(T.left)), (T.top = o(T.top))),
              (a = { marginLeft: _, marginTop: b }),
              t.each(["left", "top"], function (i, s) {
                t.ui.position[C[i]] &&
                  t.ui.position[C[i]][s](T, {
                    targetWidth: f,
                    targetHeight: m,
                    elemWidth: l,
                    elemHeight: u,
              ...
              e.using &&
                (r = function (t) {
                  ...
                  f < l && n(i + o) < f && (c.horizontal = "center"),
                    m < u && n(a + r) < m && (c.vertical = "middle"),
                    s(n(i), n(o)) > s(n(a), n(r))
      ...
      (function () {
        ...
        e.appendChild(h),
          (s = r || document.documentElement).insertBefore(e, s.firstChild),
    ...
    t.widget("ui.menu", {
      ...
      refresh: function () {
        ...
        this.element.toggleClass(
          ...
          (e = n.add(this.element).find(this.options.items))
            .not(".ui-menu-item")
            .each(function () {
              var e = t(this);
              i._isDivider(e) &&
  ...
  t.widget("ui.button", {
    ...
    _destroy: function () {
      this.element.removeClass("ui-helper-hidden-accessible"),
        this.buttonElement
          .removeClass(d + " ui-state-active " + p)
          .removeAttr("role")
          ...
          t.drawMonth = Z,
            ...
            s = this._canAdjustMonth(t, -1, tt, Z)
              ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" +
                ...
                "'>" +
                i +
                " </span><i class='fa fa-chevron-left' aria-hidden='true'></i></a>"
              : q
              ? ""
            ...
            o = this._canAdjustMonth(t, 1, tt, Z)
              ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" +
                ...
                "'>" +
                n +
                " </span><i class='fa fa-chevron-right' aria-hidden='true'></i></a>"
              : q
              ? ""
      ...
      t.extend(t.effects, {
        ...
        restore: function (t, e) {
          ...
          for (s = 0; s < e.length; s++)
            null !== e[s] &&
              (void 0 === (i = t.data(x + e[s])) && (i = ""), t.css(e[s], i));
        },
  ...
  t.effects,
    (t.effects.effect.blind = function (e, i) {
      ...
      a.parent().is(".ui-effects-wrapper")
        ...
        : t.effects.save(a, r),
        a.show(),
        (n = (s = t.effects.createWrapper(a).css({ overflow: "hidden" }))[u]()),
        (o = parseFloat(s.css(d)) || 0),
        (f[u] = m ? n : 0),
        p ||
          (a
    ...
    (t.effects.effect.bounce = function (e, i) {
      ...
      for (
        ...
        ((n = {})[v] = (_ ? "-=" : "+=") + d),
          ...
          (d = l ? 2 * d : d / 2);
      l &&
        (((n = { opacity: 0 })[v] = (_ ? "-=" : "+=") + d), a.animate(n, m, g)),
        a.queue(function () {
          l && a.hide(),
            t.effects.restore(a, r),
            t.effects.removeWrapper(a),
    ...
    (t.effects.effect.explode = function (e, i) {
      ...
      for (s = 0; s < l; s++)
        for (a = p.top + s * m, h = s - (l - 1) / 2, n = 0; n < c; n++)
          (o = p.left + n * f),
            (r = n - (c - 1) / 2),
            u
              .clone()
    ...
    (t.effects.effect.size = function (e, i) {
      ...
      "show" === d && a.show(),
        ...
        "toggle" === e.mode && "show" === d
          ? ((a.from = e.to || _), (a.to = e.from || s))
          : ((a.from = e.from || ("show" === d ? _ : s)),
        ...
        ("content" !== f && "both" !== f) ||
          ...
          a.find("*[width]").each(function () {
            ...
            p && t.effects.save(i, h),
              ...
              o.from.x !== o.to.x &&
                ((i.from = t.effects.setTransition(i, u, o.from.x, i.from)),
  ...
  t.widget("ui.spinner", {
    ...
    pageDown: C(function (t) {
      this._stepDown((t || 1) * this.options.page);
    }),
    value: function (t) {
      if (!arguments.length) return this._parse(this.element.val());
      C(this._value).call(this, t);
    },
    widget: function () {
    ...
    t.widget("ui.tabs", {
      ...
      _isLocal:
        ...
        function (t) {
          var e, i;
          (e = (t = t.cloneNode(!1)).href.replace(D, "")),
        ...
        s &&
          ((n = this._find(i))
            ...
            : (i.is("[title]") &&
              ...
              this.liveRegion.children().hide(),
              s.clone
                ? (r = s.clone()).removeAttr("id").find("[id]").removeAttr("id")
                : (r = s),
