(function () {
  ...
  ((i = (function () {
    ...
    return (
      ...
      (t.prototype.add_group = function (t) {
        ...
        for (
          ...
          (o = r[s]), n.push(this.add_option(o, e, t.disabled));
        return n;
      }),
    ...
    var e, s, o, r, n;
    for (r = new i(), s = 0, o = (n = t.childNodes).length; s < o; s++)
      (e = n[s]), r.add_node(e);
    return r.parsed;
  }),
    (e = (function () {
      ...
      return (
        ...
        (t.prototype.results_option_build = function (t) {
          var e, s, i, o, r, n, h;
          for (
            e = "", h = 0, o = 0, r = (n = this.results_data).length;
            o < r &&
            ((i = ""),
            "" !==
              (i = (s = n[o]).group
        ...
        (t.prototype.reset_single_select_options = function () {
          var t, e, s, i, o;
          for (o = [], t = 0, e = (s = this.results_data).length; t < e; t++)
            (i = s[t]).selected ? o.push((i.selected = !1)) : o.push(void 0);
          return o;
        }),
        ...
        (t.prototype.winnow_results = function (t) {
          var e, s, i, o, r, n, h, l, c, _, a, u, d, p, f;
          for (
      ...
      chosen: function (i) {
        return e.browser_is_supported()
          ? this.each(function (e) {
              var o, r;
              (r = (o = t(this)).data("chosen")),
                "destroy" !== i
                  ? r instanceof s || o.data("chosen", new s(this, i))
    ...
    (s = (function (s) {
      ...
      return (
        ...
        (o.prototype.escape_html = function (e) {
        ...
        (o.prototype.no_results = function (t) {
          var e;
          return (
        ...
        (o.prototype.search_field_scale = function () {
          ...
          if (this.is_multiple) {
            for (
              ...
              r[(o = n[s])] = this.search_field.css(o);
            return (
        ...
        (o.prototype.trigger_form_field_change = function (t) {
          return (
