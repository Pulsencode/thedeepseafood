...
@method_decorator(login_required(login_url='/superadmin/'),name='dispatch')
...
class RecipeCreateView(UserPassesTestMixin,TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        recipe = RecipeDetails(brand=brand,title=name,description=desc,image_alt=image_alt)
        recipe.save()
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['brands'] = Brand.objects.filter(status=True).exclude(name="Deep Sea").order_by('-id')
        return context
...
class RecipeUpdateView(UserPassesTestMixin,TemplateView):
    ...
    def get(self, request, id):
        ...
        return render(request, self.template_name, {'list': data,'brands':brand,'sliders':sliders,'whyc':why})
...
class GalleryCreateView(UserPassesTestMixin,TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        gallery = EventGallery(title=title,location=location,description=desc,date=date,sequence=sequence,image_alt=image_alt)
        gallery.save()
...
class NewsCreateView(UserPassesTestMixin,TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        news = NewsDetails(sequence=sequence,title=title,name=name,location=location,description=desc,date=date,type=type,image_alt=image_alt,title_tag=title_tag,metatag=metatag,keyword=keyword,canonical=canonical)
        news.save()
...
class PromotionCreateView(UserPassesTestMixin,TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        promotion = PromotionDetails(title=title,name=name,location=location,description=desc,date=date)
        promotion.save()
...
class BlogCreateView(UserPassesTestMixin,TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        blog = BlogDetails(title=title,name=name,location=location,description=desc,date=date,title_tag=title_tag,metatag=metatag,keyword=keyword,canonical=canonical,image_alt=image_alt)
        blog.save()
...
class TeamCreateView(UserPassesTestMixin,TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        team = ManagementTeam(name=name,sequence=sequence,designation=designation,image_alt=image_alt)
...
class CareerCreateView(UserPassesTestMixin,TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        career = VaccancyDetails(salary=salary,type=types_str,title=name,description=desc,location=location)
        career.save()
...
class CareerUpdateView(UserPassesTestMixin,TemplateView):
    ...
    def get(self, request, id):
        ...
        return render(request, self.template_name, {'list': data,'types_list':types_list})
...
class ApplicationListView(UserPassesTestMixin,TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if is_ajax(request):
            if search:
                cd = cd.filter(Q(first_name__icontains=search) | Q(job__icontains=search))
            if sts:
                cd = cd.filter(status=sts)
            if status:
                if status == '1':
...
class HistoryCreateView(UserPassesTestMixin,TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        history = HistoryDetails(title=title,year=year,description=desc,image_alt=image_alt)
        history.save()
...
class EnquiryListView(UserPassesTestMixin,TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if is_ajax(request):
            if search:
                cd = cd.filter(Q(name__icontains=search) | Q(created__range=(start, end)))
            if delete:
                item_id = request.GET.get("item_id")
                try:
            ...
            if start_date and end_date:
                cd = cd.filter(created__date__gte=start_date,created__date__lte=end_date)
...
class ExportExcel(View):
    def get(self, request):
        if request.META.get('HTTP_X_REQUESTED_WITH') == 'XMLHttpRequest':
            ...
            try:
                enquiries = EnquiryDetails.objects.filter(created__gte=start, created__lte=end)
                enquiries_data = [{'product': enquiry.product,
                                   'name': enquiry.name,
                                   'location': enquiry.location,
                                   'email': enquiry.email,
                                   'mobile_no': enquiry.mobile_no,
                                   'message': enquiry.message,
                                   'created': enquiry.created.strftime('%Y-%m-%d %H:%M:%S')} for enquiry in enquiries]
...
class ProductCreateView(UserPassesTestMixin,TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        product = Product(name=name,brand=brand, type=type,title_tag=title_tag,metatag=metatag,keyword=keyword,canonical=canonical,sequence=sequence,image_alt=image_alt)
...
class ProductDetailsListView(UserPassesTestMixin,TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        cd = ProductDetails.objects.filter(product__brand__name='Deep Sea').order_by('-id')
...
class ProductDetailsCreateView(UserPassesTestMixin,TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        product_details = ProductDetails(product=product, category=category, sub_categories=sub,price=price,product_code=code,net_weight=weight,origin=origin,grade=grade,packing=packing,description=desc,ingredients=ingredient,instructions=instruction,storage_instructions=storage,causion=causion)
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['products'] = Product.objects.filter(status=True,brand__name='Deep Sea').order_by('-id')
        context['category'] = Category.objects.filter(status=True,brand__name='Deep Sea').order_by('-id')
        return context
...
class ProductDetailsUpdateView(UserPassesTestMixin,TemplateView):
    ...
    def get(self, request, id):
        ...
        return render(request, self.template_name, {'list': data,'products':products,'category':category})
...
class BrandProductListView(UserPassesTestMixin,TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if is_ajax(request):
            if search:
                cd = cd.filter(Q(name__icontains=search) | Q(product_details__category__name__icontains=search))
            if sts:
                cd = cd.filter(status=sts)
            if status:
                if status == '1':
...
class BrandProductCreateView(UserPassesTestMixin,TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        product = Product(name=name, brand=brand,title_tag=title_tag,metatag=metatag,keyword=keyword,canonical=canonical,sequence=sequence,image_alt=image_alt)
        product.image.save(name + '.' + ext, image_data, save=True)
...
class BrandProductDetailsListView(UserPassesTestMixin,TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        cd = ProductDetails.objects.exclude(product__brand__name='Deep Sea').order_by('-id')
...
class BrandProductDetailsCreateView(UserPassesTestMixin,TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        causion = request.POST.get("causion") # This is now used for allergen information
        description = request.POST.get("description") # This is now used for nutritional facts
        
        product_details = ProductDetails(product=product, category=category, net_weight=weight,origin=origin,storage_instructions=storage,shelf_life=shelf,how_to_cook=cook, ingredients= ingredients, causion=causion, description=description )
        product_details.save()
    ...
    def get(self, request):
        if request.META.get('HTTP_X_REQUESTED_WITH') == 'XMLHttpRequest':
            ...
            try:
                ...
                brand = product.brand
                category = list(Category.objects.filter(brand=brand).values('id','name'))
...
class SeoCreateView(UserPassesTestMixin,TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        seo = Seo(page=page,title_tag=title_tag,metatag=metatag,keyword=keyword,canonical=canonical)
        seo.save()
